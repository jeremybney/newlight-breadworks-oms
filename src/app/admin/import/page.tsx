...
// Exact mapping: CSV column header -> product ID in Firestore
    ...
    <AppShell>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-6 card p-5 text-sm text-bark-800/70 space-y-2">
          ...
          <div className="flex gap-2"><span className="text-wheat-500 font-bold">2.</span> Upload that CSV file above — you'll see a preview of all customers</div>
          ...
          <div className="flex gap-2"><AlertTriangle className="w-4 h-4 text-wheat-500 flex-shrink-0 mt-0.5" /><span>Running the import twice will create duplicate customers. Delete existing ones first if you need to re-import.</span></div>
        </div>
      </div>
    </AppShell>
  )
